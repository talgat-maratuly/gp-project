...
export const NAV_ITEMS = [
  ...
  { path: '/partners/moderation', labelKey: 'partner_moderation', icon: 'Briefcase', roles: ['SUPER_ADMIN', 'FRANCHISE_ADMIN', 'MANAGER'] },
  { path: '/specialists/moderation', labelKey: 'specialist_moderation', icon: 'UserCog', roles: ['SUPER_ADMIN', 'FRANCHISE_ADMIN', 'MANAGER'] },
  { path: '/specialists/offerings', labelKey: 'specialist_offerings_moderation', icon: 'Wrench', roles: ['SUPER_ADMIN', 'FRANCHISE_ADMIN', 'MANAGER'] },
  { path: '/services/moderation', labelKey: 'service_moderation', icon: 'Wrench', roles: ['SUPER_ADMIN', 'FRANCHISE_ADMIN', 'MANAGER'] },
  ...
  { path: '/market/products/moderation', labelKey: 'product_moderation', icon: 'Package', roles: ['SUPER_ADMIN', 'FRANCHISE_ADMIN', 'MARKET_MANAGER'] },
...
export const PAGE_TITLE_KEYS = {
  ...
  '/specialists/offerings': 'specialist_offerings_moderation',
